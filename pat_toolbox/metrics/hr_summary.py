...
def append_hr_prv_summary(
    ...
    *,
    ...
    Append one PAT-only summary row with:
      ...
      - sleep-stage and exclusion-mask summaries
    """
    ...
    base_order = [
        ...
        "selected_lf_fixed_mean_ms2", "selected_lf_fixed_median_ms2", "selected_hf_fixed_mean_ms2", "selected_hf_fixed_median_ms2", "selected_lf_hf_fixed_mean", "selected_lf_hf_fixed_median", "selected_lf_hf_fixed_n_windows_valid",
        ...
        "nrem_first_half_rmssd_mean_ms", "nrem_first_half_rmssd_median_ms", "nrem_first_half_rmssd_valid_min", "nrem_first_half_rmssd_valid_pct", "nrem_first_half_sdnn_mean_ms", "nrem_first_half_sdnn_median_ms", "nrem_first_half_sdnn_valid_min", "nrem_first_half_sdnn_valid_pct", "nrem_first_half_lf_fixed_mean_ms2", "nrem_first_half_lf_fixed_median_ms2", "nrem_first_half_hf_fixed_mean_ms2", "nrem_first_half_hf_fixed_median_ms2",
        "nrem_first_half_lf_hf_fixed_mean", "nrem_first_half_lf_hf_fixed_median", "nrem_first_half_lf_hf_fixed_n_windows_valid", "nrem_first_half_lf_hf_fixed_valid_min",
        "nrem_second_half_rmssd_mean_ms", "nrem_second_half_rmssd_median_ms", "nrem_second_half_rmssd_valid_min", "nrem_second_half_rmssd_valid_pct", "nrem_second_half_sdnn_mean_ms", "nrem_second_half_sdnn_median_ms", "nrem_second_half_sdnn_valid_min", "nrem_second_half_sdnn_valid_pct", "nrem_second_half_lf_fixed_mean_ms2", "nrem_second_half_lf_fixed_median_ms2", "nrem_second_half_hf_fixed_mean_ms2", "nrem_second_half_hf_fixed_median_ms2",
        "nrem_second_half_lf_hf_fixed_mean", "nrem_second_half_lf_hf_fixed_median", "nrem_second_half_lf_hf_fixed_n_windows_valid", "nrem_second_half_lf_hf_fixed_valid_min",
